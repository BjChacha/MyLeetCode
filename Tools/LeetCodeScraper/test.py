...
url_leetcode_problem = 'https://leetcode.com/problems/rotate-string/'
...
print("="*70)
print(f"Problem name:       {content['data']['question']['title'] : >20}")
print(f"Problem no:         {content['data']['question']['questionFrontendId'] : >20}")
print(f"Problem difficulty: {content['data']['question']['difficulty'] : >20}")
print("Problem tags:")
for t in topics:
    print(f"\t{t}")
print("="*70)